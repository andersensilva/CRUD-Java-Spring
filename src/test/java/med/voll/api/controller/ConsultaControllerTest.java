...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver codigo http 400 quanod informacoes estao invalidos")
    @WithMockUser
    ...
    void agendar_cenario2() throws Exception {
       ...
       var dadosDetalhanmento = new DadosDetalhamentoConsulta(null, 2L, 5L, data);
               when(agendaDeConsultas.agendar(any())).thenReturn(dadosDetalhanmento);
